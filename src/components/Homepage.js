  ...
  return (
   ...
   <Link to="/about"  style={{textDecoration:"none"}} className='class001'>Student Coordinators</Link>
      ...
      <div className="vice_desk" id="vice_desk_01">
        ...
        {/* <div className="text_vice_desk">  */}
        <p>
        Madan Mohan Malviya University of Technology, Gorakhpur is <br/> one of the established university of India. It's always an <br/> endeavour for entire academic fraternity to raise the <br/> placement year on year by imparting essential technical and <br/> non-technical techniques to students due to which they <br/> become competent to face the industry challenges. I am also <br/> proud to say that MMMUT has faced the challenges <br/> successfully. This is possible due to outstanding efforts of the <br/> faculty and of the bright students who are selected after a <br/> stringent process. Our alumni have achieved tremendous <br/> success in all sphere and this bears an eloquent testimony to <br/> our efforts.
        </p>
        {/* </div> */}
        <div>
   ...
   <img src="https://res.cloudinary.com/dd6idpm2e/image/upload/v1655502070/cell_website/facebook_objqnq.png" alt="Error loading iage"/>
   <img src="https://res.cloudinary.com/dd6idpm2e/image/upload/v1655502070/cell_website/linkedin_wboyqx.png" alt="Error loading iage"/>
